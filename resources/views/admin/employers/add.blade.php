        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="datetime" class="form-control float-right" name="birth" id="reservation">
                </div>
                <!-- /.input group -->
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">الأيميل </label>
                <input type="email" class="form-control" placeholder="أدخل الإيميل" name="email">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="grade">المهنة</label>
                <input type="text" class="form-control" placeholder="المهنة" name="grade">
            </div>
            <div class="form-group">
                <label for="grade">المرتب</label>
                <input type="text" class="form-control" placeholder="المرتب" name="salary">
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="datetime" class="form-control float-right" id="reservation" name="graduation">
                </div>
                <!-- /.input group -->
            </div>
            <div class="form-group">
                ...
                <select class="form-control" style="width: 100%;" name="married">
                    <option value="داخل العمل">داخل العمل</option>
                    <option value ="خارج العمل">خارج العمل</option>
